		...
		<div class="carousel-item">
			...
			<div class="carousel-caption d-none d-md-block">
				<div class="banner-content col-lg-12 col-md-12">
					...
					<p class="text-white">е Бенефициент по договор за безвъзмездна помощ по ОПИК - BG16RFOP002-2.002-0229-C01 “Развитие на управленския капацитет за растеж в АВИОРЕМОНТЕН ЗАВОД ЕООД”</p>
				</div>
			</div>
		</div>
		<div class="carousel-item">
			...
			<div class="carousel-caption d-none d-md-block">
				<div class="banner-content col-lg-12 col-md-12">
					...
					<ul style="text-align: left;">
						<li>- Ремонт на летателни апарати и агрегати;</li>
						<li>- Производство и ремонт на самолетообслужваща техника и нестандартно оборудване;</li>
						<li>- Ремонт на самолетна техника.</li>
					</ul>
				</div>
			</div>
		</div>
		<div class="carousel-item">
			...
			<div class="carousel-caption d-none d-md-block">
				<div class="banner-content col-lg-12 col-md-12">
					...
					<p class="text-white">разполага с квалифицирани специалисти и собствена ремонтна база в гр.Монтана</p>
				</div>
			</div>
		</div>
		<div class="carousel-item">
		...
		<div class="carousel-item">
			...
			<div class="carousel-caption d-none d-md-block">
				...
				<div class="banner-content col-lg-12 col-md-12" style="text-align: left">
					...
					<ul>
						<li>1. Внедряване и сертификация на Системи за управление ISO 9001 и ISO 14001</li>
						<li>2. Реинженеринг на за оптимизация на процесите</li>
						<li>3. Инвестистии в технологично оборудване</li>
					</ul>
				</div>
			</div>
		</div>
